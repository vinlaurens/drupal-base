...
if (file_exists('../config/settings.local.php')) {
  include '../config/settings.local.php';
}

// Include server settings if they exist.
$localSettingsPath = '/var/www/_config/SITENAME.settings.php';
if (file_exists($localSettingsPath)) {
  include $localSettingsPath;
}
